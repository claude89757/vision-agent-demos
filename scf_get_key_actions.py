...
# ===== 主要入口：处理网球视频 =====
def process_tennis_video(video_path: str, output_dir: str = "/tmp/tennis_video_output") -> dict:
    """
...
if __name__ == "__main__":
    process_tennis_video("/Users/claude89757/github/vision-agent-demos/videos/Roger_Federer.mp4", "/Users/claude89757/github/vision-agent-demos/output")